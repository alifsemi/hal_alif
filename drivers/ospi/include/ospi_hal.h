...
#define OSPI_EVENT_DATA_LOST         (1UL << 1)     /* Data lost: Receive overflow / Transmit underflow */
#define OSPI_EVENT_MODE_FAULT        (1UL << 2)     /* Master Mode Fault (SS deactivated when Master) */
...
struct ospi_trans_config {
    ...
    uint8_t  data_frame;            /* Data Frame Size [8, 16, 32] */
    ...
    uint8_t  rd_ds_enable;          /* Read Data Strobe Enable */
};
